# Apple User Bill of Rights

Apple is about to spend a week telling us about the future of its platforms. Before that happens, users deserve a plainer promise about the present.

The machine I paid for should behave like mine.

That sentence should not sound radical. It should be the floor. A Mac should feel like a personal computer, not vendor territory with nice typography. An iPhone should feel like a device I own, not a permissioned appliance I am allowed to inhabit.

Apple has always asked users to accept tradeoffs. Many of us accepted them gladly. We accepted more control because Apple promised more care. We accepted tighter platforms because Apple promised safety, coherence, and peace of mind.

That bargain only works if Apple holds up its side.

Too often, the user pays in money, agency, hassle, and then again in subscriptions. Apps scatter files through `~/Library`. "Uninstall" means "remove the visible icon and leave the rest for the user to excavate." Background helpers hide behind vague names. Login items appear without plain explanations. The App Store still contains scams, cloneware, predatory subscriptions, and junk. iOS locks down the device in the name of protection, then treats reasonable user agency as suspicious.

This is not elegance. This is maintenance disguised as simplicity.
...
- Remove the app and every trace it created
...
I bought a Mac. I bought an iPhone. I did not buy a mall kiosk for subscriptions, upsells, storage nudges, bundles, payment rails, media services, cloud locks, and app-store tolls.

Services can be useful. iCloud can be useful. The App Store can be useful. Apple Music, Apple TV, AppleCare, Fitness, News, Arcade, and the rest may be good products for people who want them.

They should not become the gravitational center of the device.

A personal computer should not constantly steer its owner toward renting more of the experience back from the company that sold it. A phone should not treat "sign in," "subscribe," "upgrade storage," and "join the ecosystem" as the default answer to every problem.
...
Apple can build locked-down systems. Apple can build elegant systems. Apple can build systems that protect users from malicious software and from vendor mess.

That is the point.

If Apple wants platform-level trust, it should provide platform-level cleanup, clarity, and accountability.
